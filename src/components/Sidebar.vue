        ...
        <el-scrollbar v-if="isSidebar" class="ep-scrollbar">
          ...
          <ul class="ep-menu-body">
            <template v-for="(item, index) in menus">
              <li
                :class="['ep-submenu', (selIndex === index && selTwoIndex === -1) && 'selectedItemBgc']" 
                :key="index"
                ...
                <transition name="slide-fade" :key="index">
                  <ul class="ep-menu-body" v-show="isExpand && selIndex === index">
                    <template v-for="(two, i) in item.children">
                      <li
                        :class="['ep-submenu', (selTwoIndex === i && selThreeIndex === -1) && 'selectedItemBgc']" 
                      ...
                      <transition name="slide-fade" :key="i">
                        <ul class="ep-menu-body" v-show="isExpandTwo && selTwoIndex === i">
                          <template v-for="(three, j) in two.children">
                            <li
                              :class="['ep-submenu', (three.location === routePath) && 'selectedItemBgc']" 
...
<style lang="less">
  .selectedItemBgc{background: #1891ff;}
  .ep-aside {
    min-height: 100vh;
    ...
    .ep-menu {
      ...
      .ep-menu-body{
        .ep-submenu{margin:0 10px;}
        .ep-menu-body{
          .ep-submenu{padding-left: 10px;margin:0 15px;}
          .ep-menu-body .ep-submenu{padding-left: 20px;}
        }
      }
      .ep-submenu {
        position: relative;
